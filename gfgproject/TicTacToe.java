...
public class TicTacToe {
      ...
      static String turn;
        ...
        // This method is for to decide the winner
    ...
    public static void main(String[] args) {
        ...
        printBoard();
        System.out.println("X will be play first. Enter a slot number to place X in:");
    ...
    while (winner == null) {
        ...
        try{
            ...
            if(!(numInput > 0 && numInput <=9)){
                System.out.println("Invalid input, re-enter the input slot number");
                continue;
            }
